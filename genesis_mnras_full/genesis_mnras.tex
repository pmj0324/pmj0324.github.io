...
proximity to the cosmic variance floor, and comparison with prior work.
Section~\ref{sec:disc_limitations} identifies limitations and future
directions, and Section~\ref{sec:conclusions} concludes.

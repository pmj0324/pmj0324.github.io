...
\lfoot{\color{textgray}\small\textit{Last updated: August 2026}}
\cfoot{\small - \thepage\ -}
...
\newcommand{\experienceitem}[4]{
    ...
    \begin{minipage}[t]{0.74\linewidth}\raggedright\textbf{#1}\end{minipage}%
    \hfill%
    \begin{minipage}[t]{0.25\linewidth}\raggedleft\mbox{\color{primary}\small #2}\end{minipage}
...
\experienceitem{Generative AI for Cosmological Simulation and Super-Resolution}{Jun 2026 -- Present}{Supervisor: Ji-Hoon Kim, Department of Physics and Astronomy, Seoul National University}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
        \item Developing generative AI models for cosmological simulation and super-resolution.
    \end{itemize}
}

\experienceitem{Generative Modeling for Multifield Cosmological Simulation}{May 2025 -- Present}{Independent Research}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
        \item Developed GENESIS, a flow-matching emulator for multifield cosmological generation using CAMELS simulation data.
...
\experienceitem{Transformer-Based Reconstruction Model for SWGO}{Jun 2024 -- Feb 2026}{Supervisor: Ian Watson, Department of Physics, University of Seoul}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
...
\experienceitem{Generative AI for IceCube and SWGO}{May 2024 -- Feb 2026}{Supervisor: Chang Dong Rho, Department of Physics, Sungkyunkwan University}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
...
\experienceitem{CNN and Vision Transformer for IceCube Camera Analysis}{Aug 2023 -- Sep 2025}{Supervisor: Carsten Rott (University of Utah \& Sungkyunkwan University)}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
...
\conferenceitem{Apr 2026}{[Talk] Generative AI for IceCube Observatory}{103rd Spring Meeting of the Korean Physical Society, Daejeon, Republic of Korea}

\conferenceitem{Apr 2026}{[Poster] Mixture Density Networks for Fast Detector Response Simulation in SWGO}{103rd Spring Meeting of the Korean Physical Society, Daejeon, Republic of Korea}
...
\conferenceitem{Sep 2024}{[Talk] Deep Learning for Ice-Property Measurement Using Simulation Images}{IceCube Collaboration Meeting, Madison, Wisconsin, USA}
...
Frameworks     & PyTorch, MATLAB, JAX \\[6pt]
Architectures  & Transformer, Diffusion Transformer (DiT), Linformer, Vision Transformer (ViT), Swin Transformer, CNN, ResNet, U-Net, Perceiver \\[6pt]
Models         & VAE, Diffusion Models, Flow Models, Mixture Density Networks, Physics-Informed Neural Networks, Masked Autoencoder (MAE) \\[6pt]
Methods        & Optimal Transport Flow Matching, Rotary Positional Embedding (RoPE), Transformer Scaling Laws \\[6pt]
\end{tabularx}
...
\noindent
\textbf{Korean} -- Native \\
\textbf{English} -- Professional working proficiency (OPIc AL)

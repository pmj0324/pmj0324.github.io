...
\experienceitem{Generative AI for Multi-Field Cosmological Simulation}{May 2025 -- Present}{Independent Research}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
        \item Developed GENESIS, an optimal-transport flow-matching emulator for joint dark matter, gas, and temperature generation across the CAMELS parameter space.

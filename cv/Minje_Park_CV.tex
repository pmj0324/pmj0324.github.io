...
\experienceitem{GENESIS: Multi-Field Cosmological Simulation and Inference}{May 2025 -- Present}{Independent Research}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
        \item Designed GENESIS (GENerative AI for thE Simulation and Inference of cosmological fieldS) for conditional cosmological field generation and training-free parameter inference.
        \item The model learns a conditional probability-flow vector field and integrates it to generate dark matter, gas, and temperature fields conditioned on CAMELS parameters.
    \end{itemize}
}

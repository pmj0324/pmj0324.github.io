...
\experienceitem{Flow and Diffusion Models for Cosmic Web Generation}{Oct 2025 -- Present}{Independent Research}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
        \item Developed flow and diffusion models to generate 2D cosmic web images using the CAMELS simulation suite.
    \end{itemize}
}

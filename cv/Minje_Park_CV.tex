...
\experienceitem{Generative AI for Multi-Field Cosmological Simulation}{May 2025 -- Present}{Independent Research}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
        \item Developed GENESIS (GENerative AI for thE Simulation and Inference of cosmological fieldS), an optimal-transport flow-matching emulator for joint dark matter, gas, and temperature generation across the CAMELS parameter space.
        \item Developing astrophysical and cosmological parameter inference by maximum-likelihood estimation.
    \end{itemize}
}

\experienceitem{JANUS: Generative AI for IceCube}{May 2024 -- Present}{Supervisor: Chang Dong Rho, Department of Physics, Sungkyunkwan University}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
        \item Developed diffusion and flow-matching models to generate realistic IceCube detector events conditioned on neutrino properties.
        \item Developing downstream event-level inference using the JANUS framework.
    \end{itemize}
}
...
\experienceitem{Transformer-Based Reconstruction for SWGO}{Jun 2024 -- Present}{Supervisor: Ian Watson, Department of Physics, University of Seoul}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
        \item Contributed to transformer-based primary-particle reconstruction in SWGO.
        \item Investigated position embedding strategies for water-Cherenkov detector time-series.
    \end{itemize}
}

\experienceitem{CNN and Vision Transformer for IceCube OPTICUS Camera Analysis}{Aug 2023 -- Sep 2025}{Supervisor: Carsten Rott, Department of Physics, Sungkyunkwan University}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
...
\conferenceitem{Jan 2026}{[Poster] Investigation of IGZO-Based 3D Vertical Channel Transistors and Physics-Informed Neural Network Modeling for Next-Generation DRAM}{The 33rd Korean Conference on Semiconductors, Jeongseon, Republic of Korea}
...
Architectures  & Transformer, Vision Transformer (ViT), Swin Transformer, CNN, ResNet, U-Net, Perceiver \\[6pt]
Models         & VAE, Diffusion Model, Flow Matching Model, Mixture Density Network, Physics-Informed Network, Masked Auto Encoder \\[6pt]
\end{tabularx}

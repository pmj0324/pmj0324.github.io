...
\experienceitem{Generative AI for Multi-Field Cosmological Simulation}{May 2025 -- Present}{Independent Research}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
        \item Developed GENESIS (GENerative AI for thE Simulation and Inference of cosmological fieldS), a network built to do two tasks at once: generate cosmological fields and support parameter inference.
        \[
        ...
        \]
        \item The learned probability-flow vector field generates dark matter, gas, and temperature fields conditioned on CAMELS parameters, and the same flow is used without additional training for likelihood-based inference.
        \[
        \log p_\theta(\mathbf{x}_1 \mid \mathbf{c}) = \log p(\mathbf{x}_0) - \int_0^1 \nabla \cdot \mathbf{v}_\theta(\mathbf{x}_t,t,\mathbf{c})\,dt
        \]
        We plan to maximize this likelihood to infer the cosmological parameters $\mathbf{c}$.
    \end{itemize}
}
...
\experienceitem{Generative AI for IceCube and SWGO}{May 2024 -- Present}{Supervisor: Chang Dong Rho, Department of Physics, Sungkyunkwan University}{
    \begin{itemize}[leftmargin=*, itemsep=2pt]
        \item Developed diffusion models for synthesizing PMT signals for SWGO.
        \item Built flow-matching models to generate IceCube detector signals conditioned on neutrino properties.
    \end{itemize}
}
